class BMP
  class Writer
    ...
    def write_dib_header(file)
      file << [DIB_HEADER_SIZE, @width, @height, 1, BITS_PER_PIXEL, 0, pixel_array_size, PIXELS_PER_METER, PIXELS_PER_METER, 0, 0].pack('Vl<2v2V2l<2V2')
    end
  ...
  class Reader
    ...
    def read_bmp_header(file)
      header = file.read(14)
      magic_number, file_size, reserved1, reserved2, array_location = header.unpack 'A2Vv2V'

      fail "Not a bitmap" unless magic_number == 'BM'
